...
À traiter en passe de correction de contenu après la feature parcours (décision Raouf 2026-04-17).
...
- Faire valider par Raouf chaque leçon avant écriture en DB
...
1. Valider avec Raouf la liste des leçons à mettre à jour
2. Rédiger une version corrigée de chaque leçon (draft markdown)
3. Faire valider à Raouf chaque draft avant insertion DB
