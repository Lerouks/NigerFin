          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {[
                ...
                <div key={v.title} className="bg-white rounded-xl border border-black/[0.06] p-6">
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="bg-white rounded-xl border border-black/[0.06] p-7">
                ...
                <h3 className="text-xl font-semibold mb-1">NFI B.</h3>
                <p className="text-[13px] text-gray-400 mb-3">Co-fondateur</p>
                <p className="text-gray-600 text-[15px] leading-relaxed">
                  Entrepreneur engagé et fin observateur des dynamiques économiques régionales, NFI est à l&apos;origine de la vision fondatrice de NFI REPORT. Convaincu que l&apos;Afrique mérite une presse économique d&apos;excellence, il oeuvre à construire une plateforme indépendante capable d&apos;éclairer investisseurs, dirigeants et institutions.
                </p>
              </div>
              <div className="bg-white rounded-xl border border-black/[0.06] p-7">
