  ...
  return (
    <div className="max-w-[640px] lg:max-w-[820px] mx-auto px-5 pt-8">
      <header className="mb-8">
        ...
        <h1 className="font-extrabold text-[28px] leading-tight tracking-tight text-[#1a1a1a]">
          {title}
        </h1>
        <p className="text-[15px] text-[#1a1a1a]/60 mt-3 leading-relaxed">{description}</p>
      </header>
      ...
      <div className="bg-white border border-black/[0.06] rounded-2xl p-5">
        ...
        <Link
          href={legacyHref}
          prefetch
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#1a1a1a] text-white text-[13px] font-semibold hover:bg-black transition"
        >
