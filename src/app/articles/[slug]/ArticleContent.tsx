...
import { Clock, Share2, Calendar, User } from 'lucide-react';
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mt-8">
              <CommentsSection
                ...
                initialComments={[
                  { id: '1', article_id: article._id, user_id: 'user1', user_name: 'Amadou Tanko', content: 'Excellente analyse ! Le secteur minier est vraiment crucial pour notre économie.', created_at: '2026-03-04T10:15:00Z', likes: 12, isLiked: false },
                  { id: '2', article_id: article._id, user_id: 'user2', user_name: 'Mariama Souley', content: "J'espère que ces investissements profiteront aussi aux populations locales.", created_at: '2026-03-04T11:30:00Z', likes: 8, isLiked: false },
                ]}
              />
            </div>
          </div>
