...
export function NewsletterForm() {
  ...
  return (
    <div id="newsletter" className="relative overflow-hidden rounded-xl bg-[#111] p-8 md:p-10">
      ...
      <h3 className="text-[22px] md:text-[26px] text-white mb-2 leading-tight">Restez informé</h3>
      ...
      {subscribed ? (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            type="submit"
            className="bg-white text-black px-6 py-3 rounded-lg hover:bg-white/90 transition-colors flex items-center justify-center gap-2 text-[14px] flex-shrink-0"
          >
            S'abonner
