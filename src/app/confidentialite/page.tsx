  ...
  return (
    <LegalPageLayout
      ...
      sections={[
        ...
        { heading: 'Vos droits', text: "Conformément à la législation en vigueur, vous disposez d'un droit d'accès, de rectification, de suppression et de portabilité de vos données personnelles. Contactez-nous à : contact@nfireport.ne." },
      ]}
    />
  );
}
