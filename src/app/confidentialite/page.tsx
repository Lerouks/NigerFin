  ...
  return (
    <DynamicLegalPage
      ...
      introParagraphs={[
        ...
        "Cette politique est rédigée conformément à la législation nigérienne en vigueur, notamment la loi n° 2017-28 du 3 mai 2017 relative à la protection des données à caractère personnel, ainsi qu'aux textes de la CEDEAO et aux standards internationaux applicables. La Haute Autorité de Protection des Données à Caractère Personnel (HAPDP) du Niger est l'autorité de contrôle compétente. NFI Report s'engage à appliquer le principe de minimisation des données : ne collecter que les informations strictement nécessaires aux finalités décrites.",
        "Les données concernées peuvent inclure des informations d'identification (nom, prénom, adresse email lors de la création d'un compte), des données de connexion techniques (adresse IP, journaux serveur, identifiants de session), des données de paiement traitées exclusivement par nos partenaires sécurisés (iPayMoney, opérateurs Mobile Money), des données de navigation anonymisées via PostHog, et les préférences de lecture pour la personnalisation éditoriale. Aucune donnée sensible au sens légal (santé, opinion politique, orientation, données génétiques) n'est collectée.",
        "L'utilisateur dispose en permanence de droits étendus sur ses données : accès, rectification, effacement, opposition, limitation, portabilité, retrait du consentement et définition de directives post-mortem. Ces droits peuvent être exercés à tout moment en écrivant à contact@nfireport.com avec un justificatif d'identité. NFI Report s'engage à répondre dans un délai maximum de 30 jours.",
      ]}
      fallbackSections={[
        {
        ...
        },
        {
          ...
          text: "Les données personnelles peuvent être transmises aux sous-traitants techniques suivants, dans le strict cadre des finalités décrites\u00A0: Supabase (hébergement de la base de données et authentification)\u00A0; Vercel (hébergement du Site)\u00A0; iPayMoney (traitement sécurisé des paiements Mobile Money et carte bancaire)\u00A0; Resend (envoi de la newsletter et des emails transactionnels)\u00A0; PostHog (analyse d'audience)\u00A0; Sentry (suivi technique des erreurs). Ces sous-traitants sont liés à NFI Report par des engagements contractuels garantissant un niveau de sécurité et de confidentialité conforme à la réglementation applicable. NFI Report ne vend, ne loue et ne cède jamais vos données personnelles à des tiers à des fins commerciales ou publicitaires.",
        },
        {
