  ...
  return (
    <div className="min-h-screen bg-[#fafaf9]">
      ...
      <section className="bg-[#0d0d0d] text-white py-20 md:py-24 relative overflow-hidden">
        ...
        <div className="absolute -bottom-20 right-0 w-72 h-72 bg-gold/[0.03] rounded-full blur-3xl" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="space-y-6">
                {[
                  ...
                  <div key={label} className="flex items-start gap-4 group">
                    <div className="w-10 h-10 bg-[#111] text-white rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-gold transition-colors duration-300">
              ...
              <div className="bg-white p-5 rounded-xl border border-black/[0.06] relative overflow-hidden">
                <div className="absolute top-0 inset-x-0 h-[2px] bg-gradient-to-r from-transparent via-gold/20 to-transparent" />
            ...
            <div className="lg:col-span-2">
              {submitted ? (
                <div className="text-center py-20 bg-white border border-black/[0.06] rounded-2xl animate-fade-in-up">
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-7 md:p-9 border border-black/[0.06] space-y-5 relative overflow-hidden">
                  <div className="absolute top-0 inset-x-0 h-[2px] bg-gradient-to-r from-transparent via-gold/20 to-transparent" />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input id="name" type="text" required value={formData.name} onChange={(e) => setFormData(prev => ({ ...prev, name: e.target.value }))} className="w-full border border-black/[0.08] rounded-xl px-4 py-2.5 bg-[#fafaf9] focus:outline-none focus:border-gold/30 focus:ring-2 focus:ring-gold/10 transition-all text-base" placeholder="Votre nom" />
                    </div>
                    <div>
                      <label htmlFor="email" className="block text-sm font-medium mb-2">Email</label>
                      <input id="email" type="email" required value={formData.email} onChange={(e) => setFormData(prev => ({ ...prev, email: e.target.value }))} className="w-full border border-black/[0.08] rounded-xl px-4 py-2.5 bg-[#fafaf9] focus:outline-none focus:border-gold/30 focus:ring-2 focus:ring-gold/10 transition-all text-base" placeholder="votre@email.com" />
                    </div>
                  </div>

                  <div>
                    <label htmlFor="subject" className="block text-sm font-medium mb-2">Sujet</label>
                    <select id="subject" required value={formData.subject} onChange={(e) => setFormData(prev => ({ ...prev, subject: e.target.value }))} className="w-full border border-black/[0.08] rounded-xl px-4 py-2.5 bg-[#fafaf9] focus:outline-none focus:ring-2 focus:ring-gold/10 transition-all text-base">
                  ...
                  <div>
                    ...
                    <textarea id="message" required rows={6} value={formData.message} onChange={(e) => setFormData(prev => ({ ...prev, message: e.target.value }))} className="w-full border border-black/[0.08] rounded-xl px-4 py-3 bg-[#fafaf9] focus:outline-none focus:border-gold/30 focus:ring-2 focus:ring-gold/10 resize-none transition-all text-base" placeholder="Votre message..." />
                  </div>
