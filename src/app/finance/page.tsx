...
export default async function FinancePage() {
  const { articles, total } = await getArticlesByCategory('finance', 1, 500);
  return (
    <div className="min-h-screen bg-[#fafaf9]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py-20">
        <SectionArticlesFiltered articles={articles} total={total} sectionLabel="Finance" sectionPath="/finance" />
      </div>
    </div>
  );
}
