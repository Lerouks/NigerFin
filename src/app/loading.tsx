...
export default function RootLoading() {
  return (
    <div
      className="fixed inset-0 bg-[#fafaf9] z-[9998] pointer-events-none"
      role="status"
      aria-live="polite"
      aria-label="Chargement de la page"
    >
      <div className="absolute top-0 left-0 right-0 h-[3px] overflow-hidden">
        <div className="loading-bar-indeterminate h-full bg-gradient-to-r from-transparent via-gold to-transparent" />
      </div>
    </div>
  );
}
