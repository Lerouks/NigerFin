...
export default function MentionsLegalesPage() {
  return (
    <LegalPageLayout
      ...
      sections={[
        { heading: 'Éditeur du site', text: 'NFI REPORT est édité par NFI Media SARL, société de droit nigérien au capital de 10 000 000 FCFA. Siège social : Boulevard de la République, Quartier Plateau, Niamey, Niger.' },
