                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:contact@nfireport.ne" className="text-gray-600 text-sm hover:text-black transition-colors">
                        contact@nfireport.ne
                      </a>
                      <br />
                      <a href="mailto:redaction@nfireport.ne" className="text-gray-600 text-sm hover:text-black transition-colors">
                        redaction@nfireport.ne
                      </a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
            ...
            <div className="lg:col-span-2">
              {submitted ? (
                <div className="text-center py-20 bg-white border border-black/[0.06] rounded-xl">
                  ...
                  <h2 className="text-2xl mb-3">Message envoyé</h2>
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-xl p-7 md:p-9 border border-black/[0.06] space-y-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full border border-black/[0.08] rounded-lg px-4 py-2.5 bg-[#fafaf9] focus:outline-none focus:border-black/15 focus:ring-1 focus:ring-black/5 transition-all text-[14px]"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full border border-black/[0.08] rounded-lg px-4 py-2.5 bg-[#fafaf9] focus:outline-none focus:ring-1 focus:ring-black/5 transition-all text-[14px]"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full border border-black/[0.08] rounded-lg px-4 py-3 bg-[#fafaf9] focus:outline-none focus:border-black/15 focus:ring-1 focus:ring-black/5 resize-none transition-all text-[14px]"
                  ...
                  <button
                    type="submit"
                    className="bg-[#111] text-white px-7 py-3 rounded-lg hover:bg-[#333] transition-colors flex items-center gap-2 text-[14px]"
                  >
