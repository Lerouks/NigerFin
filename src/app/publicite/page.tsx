  ...
  return (
    <DynamicLegalPage
      ...
      fallbackSections={[
        ...
        { heading: 'Contact commercial', text: 'Pour toute demande de partenariat ou de publicité, contactez notre équipe commerciale à : contact@nfireport.com ou au +227 91 70 71 94.' },
      ]}
    />
  );
}
