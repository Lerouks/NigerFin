  ...
  if (!isPremium) {
    return (
      <div className="relative group inline-block w-full">
        <button
          disabled
          className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-gray-100 text-gray-500 cursor-not-allowed text-[14px] border border-black/4"
        >
