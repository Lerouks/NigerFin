...
export function ChartTooltip({
  ...
  return (
    <div
      className="bg-white border border-black/[0.08] rounded-lg shadow-lg px-3 py-2.5 pointer-events-none"
      style={{ minWidth: 120 }}
    >
      {label && (
      ...
      {payload.map((entry, i) => (
        <div key={i} className="flex items-center gap-2 py-0.5">
          <div className="w-2 h-2 rounded-full flex-shrink-0" style={{ backgroundColor: entry.color || '#111' }} />
