...
export const marketData: MarketData[] = [
  { id: '1', name: 'EUR/XOF', value: 655.957, change: 0.12, changePercent: 0.018, type: 'currency', symbol: 'EUR/XOF', description: 'Taux de change fixe entre l\'euro et le franc CFA (UEMOA), assuré par un mécanisme de parité fixe et de convertibilité. Référence incontournable pour le commerce extérieur de la zone UEMOA.', educationLink: '/education/devises-change' },
  ...
  { id: '4', name: 'Pétrole brut Brent', value: 109.00, change: 0, changePercent: 0, type: 'commodity', symbol: 'ICEEUR:BRN1!', unit: 'USD/baril', description: 'Contrat futures Brent front-month (ICE Europe). Référence mondiale du prix du pétrole brut. Impacte directement le coût de l\'énergie et des transports au Niger et dans la sous-région.', educationLink: '/education/matieres-premieres' },
