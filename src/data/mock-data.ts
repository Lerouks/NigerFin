...
export const marketData: MarketData[] = [
  ...
  { id: '4', name: 'Pétrole brut Brent', value: 70.00, change: 0, changePercent: 0, type: 'commodity', symbol: 'BRENT', unit: 'USD/baril', description: 'Référence mondiale du prix du pétrole brut. Impacte directement le coût de l\'énergie et des transports au Niger et dans la sous-région.', educationLink: '/education/matieres-premieres' },
