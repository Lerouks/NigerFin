...
export const marketData: MarketData[] = [
  ...
  { id: '7', name: 'Bitcoin', value: 62450.00, change: 1250.00, changePercent: 2.04, type: 'crypto', symbol: 'BTC', unit: 'USD', description: 'Première cryptomonnaie décentralisée, créée en 2009 par Satoshi Nakamoto. Référence du marché des actifs numériques avec la plus grande capitalisation.', educationLink: '/education/cryptomonnaies' },
