...
export const marketData: MarketData[] = [
  ...
  { id: '4', name: 'Pétrole brut Brent', value: 108.95, change: 6.83, changePercent: 6.69, type: 'commodity', symbol: 'BRENT', unit: 'USD/BLL', description: 'Référence mondiale du prix du pétrole brut. Impacte directement le coût de l\'énergie et des transports au Niger et dans la sous-région.', educationLink: '/education/matieres-premieres' },
