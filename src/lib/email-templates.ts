...
<tr><td align="center" style="padding:24px 32px 28px;background-color:#f5f5f7;border-top:1px solid #d2d2d7;">
  ...
  <p style="margin:0 0 12px;color:#86868b;font-family:'Inter',sans-serif;font-size:11px;line-height:1.65;letter-spacing:0.2px;">SARL au capital de 1 000 000 FCFA &middot; RCCM NE-NIM-01-2026-B12-00204 &middot; NIF 164936/R &middot; Siège : Quartier Plateau, Niamey, Niger<br/>Tél. +227 91 70 71 94</p>
